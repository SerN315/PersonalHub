...
export default function WidgetClient() {
  ...
  const [widgets, setWidgets] = useState<Record<string, { visible: boolean; minimized: boolean }>>({});
...
function getNextPosition(currentLayout: any[], widgetW: number, widgetH: number) {
